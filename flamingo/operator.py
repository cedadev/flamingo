...
from flamingo.utils.subset_utils import run_subset
from flamingo.utils.average_utils import run_average
from flamingo.director import wrap_director
...
class Operator(object):
    ...
    def call(self, args):
        ...
        if os.path.isfile(collection[0]):
            ...
            # In flamingo.operator, within the `Operator.call()` function, we need...
            #

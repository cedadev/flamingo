...
class Orchestrate(Process):
    def __init__(self):
        ...
        super(Orchestrate, self).__init__(
            ...
            title="Orchestrate",
            abstract="Run a workflow with combined operations. A workflow can be build using the flamingoi client.",
            metadata=[
                Metadata("flamingoi", "https://github.com/cedadev/flamingoi"),
            ],
            version="1.0",
            inputs=inputs,
            outputs=outputs,
